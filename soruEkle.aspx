<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="soruEkle.aspx.cs" Inherits="soruEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>
                <br />
               Zorluk Seviyesi <asp:DropDownList ID="DropDownList4" runat="server">
                    <asp:ListItem Value="0">Kolay</asp:ListItem>
                    <asp:ListItem Value="1">Orta</asp:ListItem>
                    <asp:ListItem Value="2">Zor</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
